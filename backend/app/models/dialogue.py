...
class Dialogue(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            name="ck_dialogue_exactly_one_subject",
        ),
        UniqueConstraint(
            "moment_id",
            "character_id",
            name="uq_dialogue_moment_id_character_id",
        ),
        UniqueConstraint(
            "moment_id",
            "group_id",
            name="uq_dialogue_moment_id_group_id",
        ),
    )
    ...
    character: Mapped["Character | None"] = relationship(back_populates="dialogue_lines")
