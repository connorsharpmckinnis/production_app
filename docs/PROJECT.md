...
- **Bookmark create/toggle UI** — moment-inspector bookmark button removed (2026-09-23) to reclaim inspector space; API + “My bookmarks” list remain. Redesign when settled.
