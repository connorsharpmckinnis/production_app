...
Authored one-way broadcasts (org-wide or production-scoped). Separate from Overview spotlight messages. See [shipped_features/app-announcements.md](shipped_features/app-announcements.md).
