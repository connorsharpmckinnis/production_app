...
- On the Overview page for a production, I need a little bit of buffer at the bottom of the page so that the bottom-most buttons aren't sitting directly on the bottom of the screen. Just a handful of pixels would be fine. → **Fixed 2026-08-26:** App shell main content bottom padding doubled (`pb-6` / `md:pb-8`).
